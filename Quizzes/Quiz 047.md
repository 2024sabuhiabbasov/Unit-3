...
def check_fraud(database):
    ...
    for row in rows:
        ...
        if not check_password(hash, hash_string):
...
db.run_save(create)
db.close()
check_fraud("payments.db")
test.run()
```
### Proof
![quiz047](https://user-images.githubusercontent.com/111758436/220648821-97618bc8-3416-4ce0-8433-8581ee7b5051.gif)
